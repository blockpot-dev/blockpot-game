...
export const GATE_DISPLAY: Record<GateType, GateDisplay> = {
    wallet_owned: { label: 'Wallet ownership', description: 'Sign-in to prove you control this wallet' },
    photo_id: { label: 'Identity', description: 'Photo ID + liveness' },
    proof_of_address: { label: 'Address', description: 'Proof of residence' },
    sof_declared: { label: 'Source of funds (declared)', description: 'Self-declared source of funds' },
    sof_documented: { label: 'Source of funds', description: 'How you funded this account' },
    sow_light: { label: 'Source of wealth (light)', description: 'Lightweight wealth review' },
    sow_forensic: { label: 'Source of wealth', description: 'Forensic review' },
    pep_screened_clear: { label: 'PEP screening', description: 'Politically-exposed person check' },
    ...
    video_kyc: { label: 'Video KYC', description: 'Live video verification call' },
