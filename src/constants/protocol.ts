// Hardcoded in the v2 Draw core contract as PEA_PER_ENTRY = 0.001 ether.
// Mirrored here only for display in surfaces that pre-date the on-chain
// `BlockpotOperator.entryQuote` breakdown (e.g. copy that quotes "0.001 ETH per entry").
...
// Hardcoded in the v2 Draw core contract as CF_BASIS_POINTS = 200 (2%).
